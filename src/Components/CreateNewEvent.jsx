...
const CreateNewEvent = ({ closeModal }) => {
  ...
  const createEvent = async (data) => {
    ...
    try {
      ...
      if (selectedClub) {
        data.clubName = selectedClub.clubName;
      }
      ...
      await axiosSecure.post("/events", data);
        ...
        <div className="w-full max-w-[960px] flex flex-col gap-8">
          ...
          <div className="flex flex-col gap-2 text-center">
            ...
            <p className="text-secondary text-base font-normal leading-normal md:mx-20">
              ...
              Managers can update these details later from the Event settings.
            </p>
          </div>
              ...
              <div className="flex flex-col gap-6">
                ...
                <label className="flex flex-col gap-2 relative">
                  ...
                  <div className="relative">
                    <select
                      className="w-full appearance-none rounded-lg bg-surface-dark border border-primary/50 
      focus:border-primary/50 focus:ring-1 focus:ring-primary h-12 px-4 pr-10 transition-all cursor-pointer"
                      {...register("clubId", {
